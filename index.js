...
</li>`).join("");w.insertAdjacentHTML("beforeend",t),new S(".gallery a").refresh()}function p(){w.innerHTML=""}let a=1,l=15;const m=document.querySelector("#search-form"),q=document.querySelector(".loader"),g=document.querySelector(".load-more");let d="";class b{constructor(t){this.loader=t}hide(){this.loader.style.display=""}show(){this.loader.style.display="block"}}function L(){const e=document.querySelector(".photo-card");if(e){const t=e.getBoundingClientRect().height;window.scrollBy({top:t*2,behavior:"smooth"})}}const n=new b(g),i=new b(q);m.addEventListener("submit",P);async function P(e){if(e.preventDefault(),d=m.elements.searchQuery.value,d===""){c.warning({title:"Alert",message:"You need to put world for searching",position:"topRight"});return}p();try{i.show(),n.hide(),a>1&&(a=1,l=15);const t=await y(d,a);if(t.total===0)return c.warning({title:"Alert",message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight"}),i.hide(),p();f(t),L(),i.hide(),n.show(),g.addEventListener("click",v)}catch(t){p(),c.warning({title:"Alert",message:t.message,position:"topRight"}),i.hide()}finally{m.reset()}}async function v(){i.show(),n.hide(),a+=1,l+=15;try{const e=await y(d,a);if(e.totalHits<=l){f(e),n.hide(),i.hide(),c.warning({title:"Alert",message:error.message,position:"topRight"}),l=15,a=1,g.removeEventListener("click",v);return}f(e),L(),i.hide(),n.show()}catch(e){c.warning({title:"Alert",message:e.message,position:"topRight"}),n.hide(),i.hide()}}
